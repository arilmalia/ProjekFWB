<header id="header" class="header d-flex align-items-center fixed-top" style="background-color: #005F5B;">
  <div class="container position-relative d-flex align-items-center justify-content-between">
    ...
    <a href="/dokter" class="logo d-flex align-items-center me-auto me-xl-0">
    ...
    <nav id="navmenu" class="navmenu">
      <ul>
        <li><a href="/dokter" class="{{ Request::is('dokter') ? 'active text-primary fw-bold' : 'text-white' }}">Home</a></li>

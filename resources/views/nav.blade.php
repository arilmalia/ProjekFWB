<header id="header" class="header d-flex align-items-center fixed-top" style="background-color: #005F5B;">
  <div class="container position-relative d-flex align-items-center justify-content-between">
    ...
    <nav id="navmenu" class="navmenu">
      <ul>
        <li><a href="/admin" class="{{ Request::is('admin') ? 'active text-primary fw-bold' : 'text-white' }}">Home</a></li>
        <li><a href="/lihatdaftar" class="{{ Request::is('lihatdaftar*') ? 'active text-primary fw-bold' : 'text-white' }}">Daftar</a></li>
        <li><a href="/lihatdokter" class="{{ Request::is('lihatdokter*') ? 'active text-primary fw-bold' : 'text-white' }}">Dokter</a></li>
        ...
        <li><a href="/logins" class="{{ Request::is('logins*') ? 'active text-primary fw-bold' : 'text-white' }}">Role</a></li>
      </ul>
